...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.default_local_dir=$HOME/checkpoints/step_wise_grpo/grpo_qwen2.5_7b_instruct_gsm8k \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=1 \
    trainer.validation_data_dir=$HOME/validation_data/step_wise_grpo/grpo_qwen2.5_7b_instruct_gsm8k \
